...
const FilterSortComponent: React.FC<FilterSortProps> = ({
  ...
  const handleKeywordChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Call onFilterChange if you want real-time filtering
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-md">
      ...
      <div className="mb-6">
        <button
          ...
          className="w-full text-left flex justify-between items-center text-gray-700 font-medium focus:outline-none"
        >
          Categories (Genres)
          <svg
